...
<html>
  <head>
    ...
    <script src="./js/make_org_chart.js"></script>
</head>
<body>
    <!-- 共通部分 -->
    <nav>
    ...
    <main>
        <h2>組織図作成</h2>
          <div class="panel panel-default">
                <div class="panel-body sosikizu-menu input-group">
                    <div class="btn-group box-type">
                        <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                            <span>縦書きボックス</span>
                            <span class="caret"></span>
                        </button>
                        <ul class="dropdown-menu" role="menu">
                            <li><a href="tategaki">縦書きボックス　<i class="fa fa-text-height"></i></a></li>
                            <li><a href="yokogaki">横書きボックス　<i class="fa fa-text-width"></i></a></li>
                        </ul>
                    </div><!-- /.box-type -->
                    <input type="text" class="form-control box-text" />
