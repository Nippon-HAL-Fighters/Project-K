...
public class EmployeeDao {
	 ...
	 * @throws SQLException
	 */
	public ArrayList<EmployeeBean> selectAreaEmployees(int area) throws SQLException {
		String selectSQL = "SELECT employee_name FROM employees where company_id = ?";

		PreparedStatement select = con.prepareStatement(selectSQL);
		select.setInt(1, area);
